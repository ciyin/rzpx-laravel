        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table style="margin-bottom: 0" width="100%">
                    ...
                    <tr style="height: 30px">
                        <td width="20%">4</td>
                        <td width="60%"><a href="http://v.youku.com/v_show/id_XMTc2MzQyMzk3Ng==.html?spm=a2hzp.8244740.userfeed.5!14~5~5~5!3~5~A.UYfmbU" onclick="save(this.innerText)">查看课表</a></td>
                        <td width="20%">6:31</td>
                    </tr>
                    <tr style="height: 30px">
                        <td width="20%">5</td>
                        <td width="60%"><a href="http://v.youku.com/v_show/id_XMTc2MzQyODYwNA==.html?spm=a2hzp.8244740.userfeed.5!15~5~5~5!3~5~A.UYfmbU" onclick="save(this.innerText)">培训记录</a></td>
                        <td width="20%">2:54</td>
                    </tr>
                    <tr style="height: 30px">
                        <td width="20%">6</td>
                    ...
                    <tr style="height: 30px">
                        <td width="20%">7</td>
                        <td width="60%"><a href="http://v.youku.com/v_show/id_XMTc2MzQzNzU3Mg==.html?spm=a2hzp.8244740.userfeed.5!13~5~5~5!3~5~A.UYfmbU" onclick="save(this.innerText)">回访记录</a></td>
                        <td width="20%">3:07</td>
                    </tr>
                    <tr style="height: 30px">
                        <td width="20%">8</td>
                        <td width="60%"><a href="http://v.youku.com/v_show/id_XMTc2NDk2OTM4NA==.html?spm=a2hzp.8244740.userfeed.5!10~5~5~5!3~5~A.UYfmbU" onclick="save(this.innerText)">其他操作</a></td>
